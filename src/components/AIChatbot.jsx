...
const AIChatbot = ({ isOpen, onClose, location = 'GENERAL' }) => {
  ...
  return (
    <div 
      className="fixed z-[100] flex flex-col bg-white dark:bg-slate-900 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.2)] border border-slate-200 dark:border-slate-700 w-[380px] h-[600px] max-h-[90vh] overflow-hidden transition-colors"
      style={{ 
        left: `${position.x}px`, 
        top: `${position.y}px`,
