                      ...
                      <div className="flex flex-wrap gap-1.5 mb-3">
                        {article.tags.slice(0, 3).map((tid) => (
                          <button
                            ...
                            className={`text-[11px] px-2 py-0.5 rounded-full border transition-colors ${activeTag === tid
              ...
              <div className="flex justify-center items-center gap-1.5 mt-8 animate-fade-in-up">
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <button
                    ...
                    className={`w-9 h-9 flex items-center justify-center rounded-lg border text-sm font-medium transition-colors ${safePage === page
                        ? "bg-blue-600 text-white border-blue-600"
              ...
              <div className="flex flex-wrap gap-2">
                {tags.map((tag) => (
                  <button
                    ...
                    className={`text-xs rounded-lg px-2.5 py-1.5 transition-colors flex items-center gap-1 border ${activeTag === tag.id
                        ? "bg-blue-600 text-white border-blue-600"
                        : "bg-gray-50 text-gray-600 border-gray-200 hover:bg-blue-50 hover:text-blue-600"
                      }`}
                  >
