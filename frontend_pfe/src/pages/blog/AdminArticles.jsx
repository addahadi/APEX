...
import { HeartIcon, BookmarkIcon, EditIcon, ArchiveIcon, TrashIcon, PublishIcon, SearchIcon, ConfirmDialog, TypeBadge, StatusBadge } from "../../components/Blog";
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {article.status === "PUBLISHED" ? (
                      ...
                      <button
                        ...
                        className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-md text-xs font-medium border transition-colors cursor-pointer whitespace-nowrap ${checks.isComplete
